    ...
    <div className="h-full flex flex-col bg-dark-bg-primary">
      ...
      <div className="flex-1 overflow-y-auto p-4">
        ...
        {getCurrentFolders().length > 0 && (
          <div className="mb-6">
            <h3 className="text-sm font-medium text-dark-text-secondary mb-3">Carpetas</h3>
                    ...
                    <div className="flex-1 min-w-0">
                      <h4 className="font-medium text-dark-text-primary truncate">
                        {folder.name}
                         ...
                         {courseMaterials.filter(m => m.type === 'file' && m.parentId === folder.id).length} archivos
                       </p>
                    </div>
        ...
        {/* Files */}
        <div>
          <h3 className="text-sm font-medium text-dark-text-secondary mb-3">Archivos</h3>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setEditingMaterial(prev => prev ? {...prev, tags: e.target.value.split(',').map(t => t.trim()).filter(t => t)} : null)}
                  className="w-full bg-dark-bg-primary border border-dark-border rounded-lg px-3 py-2 text-dark-text-primary focus:outline-none focus:border-course-blue"
            ...
            <div className="flex gap-2 mt-6">
              ...
              >
                Cancelar
                 ...
                 onClick={async () => {
                   if (editingMaterial) {
                     await useAppStore.getState().updateCourseMaterial(courseId, editingMaterial.id, {
