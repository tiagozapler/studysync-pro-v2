...
import { FreeChatService, ChatSession, ChatMessage as ChatMessageType } from '../../../lib/ai/chat/FreeChatService';
        ...
        <div className="bg-dark-bg-secondary p-8 rounded-lg shadow-modal max-w-md w-full">
          ...
          <p className="text-dark-text-secondary mb-6">
            ...
            <div>
              ...
              <div className="flex gap-2">
                 ...
                 />
                   ...
                   type="button"
                   onClick={() => {
                     const key = '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';
                     setApiKey(key);
                     setIsConfiguring(false);
            ...
            >
             ...
             <p>• Puedes obtener una API key gratuita en <a href="https://console.groq.com" target="_blank" rel="noopener noreferrer" className="text-course-blue hover:underline">console.groq.com</a></p>
             <button
               type="button"
               onClick={() => {
